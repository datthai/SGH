...
pd_ins=1/(1+exp(-(-0.03183273*risk_ins_score+51.430543518)));
...
pd_css=1/(1+exp(-(-0.033239049*risk_css_score+13.888000968)));
drop psc: SCORECARD_POINTS;
run;
...
pd_cross_css=1/(1+exp(-(-0.030182477*risk_cross_css_score+5.8533157671)));
drop psc: SCORECARD_POINTS;
run;
...
pr=1/(1+exp(-(-0.042867609*response_score+36.303537569)));
drop psc: SCORECARD_POINTS;
run;
